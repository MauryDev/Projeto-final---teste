...
import br.edu.ifba.park.iot.backend.jwt.JwtToken;
import br.edu.ifba.park.iot.backend.jwt.JwtUserDetailsService;
import br.edu.ifba.park.iot.backend.security.model.dto.usuario.request.UsuarioLoginRequestDto;
...
public class AutenticacaoController {
        ...
        @Operation(summary = "Autenticar na API", description = "Recurso para autenticar um usuário na API.", responses = {
                        ...
                        @ApiResponse(responseCode = "422", description = "Campos(s) Invalidos(s)", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorMessage.class))),
        })
        @PostMapping("/auth")
        public ResponseEntity<?> autenticar(@RequestBody @Valid UsuarioLoginRequestDto dto,
