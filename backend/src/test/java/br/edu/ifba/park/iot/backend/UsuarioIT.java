package br.edu.ifba.park.iot.backend;
...
public class UsuarioIT {
    ...
    public void _createUsuario_ComUsernameEPasswordValidos_RetornarUsuarioCriadoComStaus201(){
        UsuarioResponseDto responseBody = testClient
                ...
                .bodyValue(new UsuarioRequestDto("tody@email.com", "JAVA!@#ResTIc18"))
                .exchange()
    ...
    public void _createUsuario_ComUsernameInvalido_RetornarErrorMessageStatus422(){
        ErrorMessage responseBody = testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioRequestDto("", "JAVA!@#ResTIc18"))
                .exchange()
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioRequestDto("tody@", "JAVA!@#ResTIc18"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioRequestDto("tody@email", "JAVA!@#ResTIc18"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void _createUsuario_ComPasswordInvalido_RetornarErrorMessageStatus422(){
        ErrorMessage responseBody = testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioRequestDto("tody@gmail.com", ""))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioRequestDto("tody@gmail.com", "Senha123"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioRequestDto("tody@gmail.com", "senha@123"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioRequestDto("tody@gmail.com", "S@1a"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioRequestDto("tody@gmail.com", "Abcdef!1234567890123456789012345"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void _createUsuario_ComUsernameRepetido_RetornarUsuarioCriadoComStaus409(){
        ErrorMessage responseBody = testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioRequestDto("bob@email.com", "JAVA!@#ResTIc18"))
                .exchange()
    ...
    public void buscarUsuario_ComIdExistente_RetornarUsuarioComStatus200() {
        UsuarioResponseDto responseBody = testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "JAVA!@#ResTIc18"))
                .exchange()
                .expectStatus().isOk()
                .expectBody(UsuarioResponseDto.class)
                .returnResult().getResponseBody();
    ...
    public void editarSenha_ComDadosValidos_RetornarStatus204() {
        testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "JAVA!@#ResTIc18"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaRequestDto("JAVA!@#ResTIc18", "JAVA!@#ResTIc18", "JAVA!@#ResTIc18"))
                .exchange()
    ...
    public void editarSenha_ComCamposInvalidos_RetornarErrorMessageComStatus422() {
        ...
        responseBody = testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "JAVA!@#ResTIc18"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaRequestDto("JAVA!@#R", "JAVA!@#R", "JAVA!@#R"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "JAVA!@#ResTIc18"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaRequestDto("Abcdef!1234567890123456789012345", "Abcdef!1234567890123456789012345", "Abcdef!1234567890123456789012345"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void editarSenha_ComSenhaInvalidas_RetornarErrorMessageComStatus400() {
        ErrorMessage responseBody = testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "JAVA!@#ResTIc18"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaRequestDto("JAVA!@#ResTIc18", "JAVA!@#ResTIc18", "JAVA!@#Res"))
                .exchange()
        ...
        responseBody = testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "JAVA!@#ResTIc18"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaRequestDto("JAVA!@#ResTI", "JAVA!@#ResTIc18", "JAVA!@#ResTIc18"))
                .exchange()
                .expectStatus().isEqualTo(400)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
